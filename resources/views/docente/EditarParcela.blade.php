        ...
        <div class="right-column">
            <form action="{{ route('parcelas.actualizar', ['id' => $parcela->parc_id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="parc_area" class="form-control" value="{{ $parcela->parc_area }}"
                        required>
                </div>

                <div class="form-group">
                    <label for="parc_coord_la" class="form-label">Coordenada Latitud</label>
                    <input type="number" name="parc_coord_la" class="form-control" step="0.01"
                        value="{{ $parcela->parc_coord_la }}" required>
                </div>

                <div class="form-group">
                    <label for="parc_coord_lo" class="form-label">Coordenada Longitud</label>
                    <input type="number" name="parc_coord_lo" class="form-control" step="0.01"
                        value="{{ $parcela->parc_coord_lo }}" required>
                </div>
