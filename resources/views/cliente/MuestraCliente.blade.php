...
<body class="bg-green-50 text-gray-800">
    ...
    <header class="header py-8 bg-green-700 text-white">
        <div class="flex justify-between items-center">
            <h2 class="text-3xl font-semibold">Información de Muestras de Suelo</h2>
            <a href="{{ url('/Estudiante') }}"
                class="rounded-md px-4 py-2 hover:bg-green-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400">
                Volver
            </a>
        </div>
    </header>
    <div class="container mx-auto mt-8">
        <!-- Filtro -->
        <div class="mb-6">
            <label for="filterSelect" class="block text-green-700 font-medium">Buscar por:</label>
